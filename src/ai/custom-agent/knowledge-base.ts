...
export const projects: Project[] = [
  {
    id: 'nyra-connect',
    name: 'Nyra Connect',
    description: 'AI productivity app with journals and insights. Muhammad\'s flagship startup project focused on breaking language barriers.',
  ...
  },
  {
    id: 'buildtrack-pro',
    name: 'BuildTrack Pro',
    description: 'Construction expense tracking platform for contractors.',
  ...
  },
  {
    ...
    techStack: ['Node.js', 'PostgreSQL', 'AI/NLP'],
  ...
  },
  {
    ...
    description: 'Real-time bus booking and tracking platform.',
  ...
  },
  {
    ...
    techStack: ['ASP.NET Core 8', 'PostgreSQL'],
    features: ['Student management', 'Grades tracking', 'Attendance', 'Administration'],
    type: 'Education ERP',
