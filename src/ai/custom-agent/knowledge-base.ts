...
export const profile = {
  ...
  startup: {
    ...
    future: 'Anvil - a cross-border fintech mobile app for seamless international money transfers, where recipients automatically receive funds in their local currency with no P2P exchange or manual conversion, built as a product under Forge for the African remittance corridor',
    url: 'forgeapis.xyz',
    status: 'Pre-Launch',
  },
  dream: {
...
export const projects: Project[] = [
  ...
  },
  {
    id: 'anvil',
    name: 'Anvil',
    description: 'A cross-border fintech mobile app enabling seamless international money transfers. A sender in Nigeria or any country initiates a transfer and the recipient automatically receives funds in their local currency, with no P2P exchange or manual conversion step. Built as a product under Forge, targeting the African remittance corridor. Currently under development.',
    techStack: ['Flutter', '.NET', 'PostgreSQL'],
    features: ['Cross-border money transfers', 'Automatic local-currency payout to recipients', 'No P2P exchange or manual conversion', 'Built as a product under Forge for the African remittance corridor'],
    type: 'Cross-Border Fintech Mobile App',
    role: 'Founder & Lead Developer',
    targetUsers: 'Senders and recipients moving money across the African remittance corridor',
  },
  {
    id: 'shoplynk',
    name: 'ShopLynk',
